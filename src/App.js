...
function App() {
  ...
  return (
    <div className="App">
      ...
      <section id="summary" className={`section ${activeSection === 'summary' ? 'reveal' : ''}`}>
    ...
    <section id="experience" className={`section ${activeSection === 'experience' ? 'reveal' : ''}`}>
    ...
    <section id="projects" className={`section ${activeSection === 'projects' ? 'reveal' : ''}`}>
    ...
    <section id="education" className={`section ${activeSection === 'education' ? 'reveal' : ''}`}>
    <h2 className="section-title">Education</h2>
      <p>Bachelor of Engineering, Electronics and Telecommunication Engineering</p>
      <p>Bangalore Institute of Technology</p>
      <p>GPA: 8.6</p>
    </section>
    <section id="contact" className={`section ${activeSection === 'contact' ? 'reveal' : ''}`}>
